...
| D4 | **Sentinel (1348881) EXCLUDED from all association tests** (circular ascertainment) | **Not explicitly excluded** from any cohort | Yes (circularity) | **OPEN** — `sentinel_check_v9.py` audits presence; exclude + re-verify. (Not in the molecular 35; phenome TBD.) |
