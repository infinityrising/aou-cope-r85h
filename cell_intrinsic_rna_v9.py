...
MODULES={  # panels per verified lit synthesis (SenMayo/Saul 2022; HALLMARK; Klionsky 2021). CXCL9/10/11 kept OUT of NF-kB/SASP (IFN-inducible).
 'typeI_specific':{'SIGLEC1':'ENSG00000088827','IFI27':'ENSG00000165949','USP18':'ENSG00000184979','IFI6':'ENSG00000126709','IFI44L':'ENSG00000137959'},  # type-I-PREFERENTIAL anchors (Nombel 2025; Kim 2024)
 'typeII_IFNg':{'CXCL9':'ENSG00000138755','GBP5':'ENSG00000154451','GBP1':'ENSG00000117228','IDO1':'ENSG00000131203','ANKRD22':'ENSG00000152766'},  # IFN-γ-SPECIFIC (CXCL10/11 dropped -> shared; Ayers 2017, Fujiwara 2016)
 'sharedISG_tone':{'ISG15':'ENSG00000187608','RSAD2':'ENSG00000134321','IFIT1':'ENSG00000185745','MX1':'ENSG00000157601','OAS1':'ENSG00000089127'},  # pan type-I/II = IFN TONE, not a type (Der 1998)
...
try:
    ...
    print("\n== READ: TYPE-I-SELECTIVITY -> does R85H×cisAQ move typeI_specific(SIGLEC1/IFI27/USP18) but NOT typeII_IFNg(CXCL9/GBP5)? AQ-alone favors NFkB/senescence/↓autophagy over type-I? (type-I anchors move + γ-axis flat = type-I-selective claim) ==")
